...
// Vite configuration for the Noob CompressorLab SPA.
//
...
// 4244, the standalone's preferred port; if that port was taken the
// standalone moved up and printed the port it got):
//
//     cargo run -p noob-compressorlab --bin standalone      # terminal 1
//     VST3_WEB_STRATUM_PORT=4244 npm run dev                     # terminal 2, in web/
const serverPort = process.env.VST3_WEB_STRATUM_PORT || '4244';
