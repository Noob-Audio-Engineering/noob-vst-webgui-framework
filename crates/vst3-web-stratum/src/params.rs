...
///
/// ```
/// use vst3_web_stratum::ParamSpec;
///
...
/// to [`crate::Vst3WebStratumBuilder::param`].
///
/// ```
/// use vst3_web_stratum::ParamSpec;
///
...
pub struct ParamSpec {
    ...
    /// [`crate::Vst3WebStratum::index_of`]. Must be unique within a bridge.
    pub id: String,
    /// Human-readable name.
    pub name: String,
...
impl ParamSpec {
    ...
    ///
    /// ```
    /// use vst3_web_stratum::{ParamSpec, Taper};
    ///
...
///
/// ```
/// use vst3_web_stratum::params::{ParamSpec, ParamStore};
///
