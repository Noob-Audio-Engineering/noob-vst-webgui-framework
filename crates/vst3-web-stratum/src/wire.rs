...
//!
//! ```
//! use vst3_web_stratum::wire::{EditPhase, Frame, ParamEditWriter};
//!
//! let mut buf = Vec::new();
...
/// load) via `Vst3WebStratum::set_param*` / `sync_all_params`, not from a client
/// or the audio thread.
...
///
/// ```
/// use vst3_web_stratum::{UiEvent, event_kind};
///
...
///
/// ```
/// use vst3_web_stratum::wire::{Frame, ParamValuesWriter, PARAM_FLAG_HOST};
///
/// let mut buf = Vec::new();
