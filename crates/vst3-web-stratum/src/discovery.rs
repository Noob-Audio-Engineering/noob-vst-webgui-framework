...
//!
//! Directory ([`dir`]):
//! * Windows: `%LOCALAPPDATA%\vst3-web-stratum\instances`
//! * macOS:   `~/Library/Application Support/vst3-web-stratum/instances`
//! * Linux:   `$XDG_RUNTIME_DIR/vst3-web-stratum/instances`, else `~/.local/state/vst3-web-stratum/instances`
//!
...
pub struct Instance {
    /// The bridge name given to `Vst3WebStratum::builder`.
    pub name: String,
...
pub fn dir() -> Option<PathBuf> {
    ...
    Some(base.join("vst3-web-stratum").join("instances"))
}
...
/// timeout or the answer is not a vst3-web-stratum `/instance` body.
///
