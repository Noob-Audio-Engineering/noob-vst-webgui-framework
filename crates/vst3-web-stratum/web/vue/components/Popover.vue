 ...
 * Themed through CSS variables (`--vst3-web-stratum-panel`, `--vst3-web-stratum-border`).
 *
 * Usage:
 *
 ...
 *
 * CSS variables honoured: `--vst3-web-stratum-panel` (background), `--vst3-web-stratum-border`,
 * `--vst3-web-stratum-text`, `--vst3-web-stratum-text-dim` (title).
 */
