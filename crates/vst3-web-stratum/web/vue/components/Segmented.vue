 ...
 *
 * Styling: none. The root has class `vst3-web-stratum-segmented` (plus
 * `vertical` / `disabled`), each button `vst3-web-stratum-segment` and
...
<template>
  <div class="vst3-web-stratum-segmented" :class="{ vertical, disabled }" role="radiogroup">
    <button
      v-for="(label, i) in items"
      :key="i"
      type="button"
      class="vst3-web-stratum-segment"
