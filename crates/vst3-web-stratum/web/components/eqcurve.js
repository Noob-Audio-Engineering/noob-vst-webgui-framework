 ...
 * dynRange, solo }` where every field may be a value *or* a vst3-web-stratum Param.
 ...
 * field may be a plain value or a vst3-web-stratum `Param`; `bandValues(i)` resolves
 ...
 * ## Styling
 *
 * CSS variables: `--vst3-web-stratum-grid`, `--vst3-web-stratum-grid-strong` (0 dB line),
 * `--vst3-web-stratum-text-dim` (scale labels), `--vst3-web-stratum-curve` (composite curve
 * and fill). Band colours come from `band.color`, else
 * `PLACEMENT_COLORS[placement]`. Classes: root `.vst3-web-stratum-eq`, `.grid`
...
const CSS = `
.vst3-web-stratum-eq{position:relative;width:100%;height:100%;user-select:none;-webkit-user-select:none;touch-action:none;
  font:10px system-ui,sans-serif}
.vst3-web-stratum-eq svg{display:block;width:100%;height:100%;overflow:visible}
.vst3-web-stratum-eq .grid{stroke:var(--vst3-web-stratum-grid,rgba(255,255,255,.07));stroke-width:1}
.vst3-web-stratum-eq .grid.minor{stroke:var(--vst3-web-stratum-grid,rgba(255,255,255,.035))}
.vst3-web-stratum-eq .zero{stroke:var(--vst3-web-stratum-grid-strong,rgba(255,255,255,.2));stroke-width:1}
.vst3-web-stratum-eq text{fill:var(--vst3-web-stratum-text-dim,rgba(255,255,255,.4))}
.vst3-web-stratum-eq .band{fill:none;stroke-width:1.2;opacity:.55}
.vst3-web-stratum-eq .band.off{opacity:.15;stroke-dasharray:3 3}
.vst3-web-stratum-eq .band-fill{opacity:.09;transition:opacity .12s}
.vst3-web-stratum-eq .band-fill.hot{opacity:.26}
.vst3-web-stratum-eq .band-fill.off{opacity:.03}
.vst3-web-stratum-eq .curve{fill:none;stroke:var(--vst3-web-stratum-curve,#ffd166);stroke-width:2.2;stroke-linejoin:round}
.vst3-web-stratum-eq .curve-fill{fill:var(--vst3-web-stratum-curve,#ffd166);opacity:.09}
.vst3-web-stratum-eq .curve-hit{fill:none;stroke:transparent;stroke-width:14;cursor:ns-resize}
.vst3-web-stratum-eq .node{cursor:move;stroke:#fff;stroke-width:1.5;transition:r .1s}
.vst3-web-stratum-eq .node.off{fill-opacity:.12}
.vst3-web-stratum-eq .node.selected{stroke-width:2.5}
.vst3-web-stratum-eq g.band-g:hover .node{filter:brightness(1.2)}
.vst3-web-stratum-eq .label{pointer-events:none;font-weight:600;fill:#fff;font-size:10px}
.vst3-web-stratum-eq .hit{fill:transparent;cursor:move}
.vst3-web-stratum-eq .dyn-line{stroke-width:2;stroke-linecap:round;opacity:.7;cursor:ns-resize}
.vst3-web-stratum-eq .dyn-dot{stroke:#fff;stroke-width:1;pointer-events:none}
.vst3-web-stratum-eq .dyn-hit{stroke:transparent;stroke-width:12;cursor:ns-resize}
.vst3-web-stratum-eq .preview{fill:none;stroke:rgba(255,255,255,.35);stroke-width:1.5;stroke-dasharray:4 4;pointer-events:none}
`;
...
export class EqCurve {
  ...
  constructor(container, opts) {
    injectStyle('vst3-web-stratum-eq-css', CSS);
    this.opts = {
      sampleRate: 48000,
      minHz: 10,
      maxHz: 30000,
    ...
    root.className = 'vst3-web-stratum-eq';
