 ...
 * ## Styling
 *
 * CSS variables: `--vst3-web-stratum-key-white`, `--vst3-web-stratum-key-black`,
 * `--vst3-web-stratum-key-border`, `--vst3-web-stratum-accent` (locally held keys),
 * `--vst3-web-stratum-key-remote` (keys the plugin reports). Classes: root
 * `.vst3-web-stratum-kbd`, `.key.white` / `.key.black`, state `.on` / `.remote`,
 * `.label`.
 */
import { EventKind, injectStyle } from '../vst3-web-stratum.js';

const CSS = `
.vst3-web-stratum-kbd{position:relative;width:100%;height:100%;user-select:none;-webkit-user-select:none;touch-action:none;
  font:10px system-ui,sans-serif}
.vst3-web-stratum-kbd .key{position:absolute;box-sizing:border-box;border-radius:0 0 4px 4px;cursor:pointer;transition:background .05s}
.vst3-web-stratum-kbd .white{top:0;bottom:0;background:var(--vst3-web-stratum-key-white,#e2e8f0);border:1px solid var(--vst3-web-stratum-key-border,#0f172a);z-index:1}
.vst3-web-stratum-kbd .black{top:0;height:62%;background:var(--vst3-web-stratum-key-black,#1e293b);border:1px solid #000;z-index:2}
.vst3-web-stratum-kbd .white.on{background:var(--vst3-web-stratum-accent,#5ac8fa)}
.vst3-web-stratum-kbd .black.on{background:var(--vst3-web-stratum-accent,#5ac8fa)}
.vst3-web-stratum-kbd .white.remote{background:var(--vst3-web-stratum-key-remote,#ffd166)}
.vst3-web-stratum-kbd .black.remote{background:var(--vst3-web-stratum-key-remote,#ffd166)}
.vst3-web-stratum-kbd .label{position:absolute;bottom:3px;left:0;right:0;text-align:center;color:#334155;pointer-events:none}
.vst3-web-stratum-kbd .hint{position:absolute;top:3px;left:0;right:0;text-align:center;color:#64748b;pointer-events:none;font-size:9px}
`;
...
export class Keyboard {
   ...
   * @param {import('../vst3-web-stratum.js').Vst3WebStratumClient} client Client whose `noteOn` / `noteOff` are called.
   * @param {object} [opts]
