/**
 * Scope — canvas oscilloscope / waveform view bound to a vst3-web-stratum Stream of
...
export class Scope {
   ...
   * @param {import('../vst3-web-stratum.js').Stream} stream Stream of interleaved time-domain samples in −1..1.
   * @param {object} [opts]
