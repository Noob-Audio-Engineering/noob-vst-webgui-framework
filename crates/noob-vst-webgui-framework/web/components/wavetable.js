 ...
 * position). Root class `.noob-vst-webgui-framework-wt` (cursor `ns-resize`).
 */
import { injectStyle, plainOf } from '../noob-vst-webgui-framework.js';

const CSS = `
.noob-vst-webgui-framework-wt{position:relative;width:100%;height:100%;user-select:none;-webkit-user-select:none;touch-action:none;cursor:ns-resize}
.noob-vst-webgui-framework-wt canvas{display:block;width:100%;height:100%}
`;
...
export class WavetableView {
  ...
  constructor(container, opts = {}) {
    injectStyle('noob-vst-webgui-framework-wt-css', CSS);
    this.opts = {
      position: 0,
      depthX: 0.45,
      depthY: 0.55,
    ...
    this.el.className = 'noob-vst-webgui-framework-wt';
