 ...
 * handles. CSS variables: `--noob-vst-webgui-framework-grid`, `--noob-vst-webgui-framework-text-dim` (labels).
 * Classes: root `.noob-vst-webgui-framework-env`, `.fill`, `.line`, `.handle`, `.hit`.
 */
import { injectStyle, plainOf } from '../noob-vst-webgui-framework.js';

const CSS = `
.noob-vst-webgui-framework-env{position:relative;width:100%;height:100%;user-select:none;-webkit-user-select:none;touch-action:none}
.noob-vst-webgui-framework-env svg{display:block;width:100%;height:100%;overflow:visible}
.noob-vst-webgui-framework-env .fill{opacity:.15}
.noob-vst-webgui-framework-env .line{fill:none;stroke-width:2;stroke-linejoin:round}
.noob-vst-webgui-framework-env .grid{stroke:var(--noob-vst-webgui-framework-grid,rgba(255,255,255,.07))}
.noob-vst-webgui-framework-env .handle{stroke:#fff;stroke-width:1.5;cursor:move}
.noob-vst-webgui-framework-env .hit{fill:transparent;cursor:move}
.noob-vst-webgui-framework-env text{font:10px system-ui,sans-serif;fill:var(--noob-vst-webgui-framework-text-dim,rgba(255,255,255,.45));pointer-events:none}
`;
...
export class Envelope {
  ...
  constructor(container, opts) {
    injectStyle('noob-vst-webgui-framework-env-css', CSS);
    this.opts = { maxTime: 4, sustainWidth: 0.22, color: '#5ac8fa', ...opts };
    this.el = document.createElement('div');
    this.el.className = 'noob-vst-webgui-framework-env';
