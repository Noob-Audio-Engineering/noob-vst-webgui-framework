/**
 * Barrel export for the built-in noob-vst-webgui-framework components: dependency-free
 ...
 *
 *   // with a bundler (Vite, …) and the `@noob-audio-engineering/noob-vst-webgui-framework` package linked in
 *   import { Knob, Meter, Spectrum, EqCurve, Scope } from '@noob-audio-engineering/noob-vst-webgui-framework/components';
 *
 ...
 *   (`--noob-vst-webgui-framework-accent`, `--noob-vst-webgui-framework-text`, `--noob-vst-webgui-framework-text-dim`,
 *   `--noob-vst-webgui-framework-grid`, `--noob-vst-webgui-framework-grid-strong`, `--noob-vst-webgui-framework-track`,
 *   `--noob-vst-webgui-framework-knob-body`, `--noob-vst-webgui-framework-curve`, `--noob-vst-webgui-framework-key-*`) plus the
