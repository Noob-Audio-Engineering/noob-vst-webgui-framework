/**
 * Spectrum — canvas spectrum analyser bound to a noob-vst-webgui-framework Stream of per-bin
...
export class Spectrum {
   ...
   * @param {import('../noob-vst-webgui-framework.js').Stream} stream Stream of per-bin magnitudes.
   * @param {object} [opts]
   ...
   * @param {import('../noob-vst-webgui-framework.js').Stream} s The stream (for `ts`).
   */
  _onFrame(d, s) {
    const n = d.length;
    this._bins = n;
