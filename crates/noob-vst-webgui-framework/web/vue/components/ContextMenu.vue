 ...
 *
 * CSS variables honoured: `--noob-vst-webgui-framework-panel`, `--noob-vst-webgui-framework-border`,
 * `--noob-vst-webgui-framework-text`, `--noob-vst-webgui-framework-text-dim` (hints), `--noob-vst-webgui-framework-accent`
 * (tick).
 */
...
.cm-div {
  margin: 4px 0;
  border-top: 1px solid var(--noob-vst-webgui-framework-border, rgba(255, 255, 255, 0.1));
}
.cm-item {
  display: flex;
  align-items: center;
...
.cm-check {
  width: 12px;
  color: var(--noob-vst-webgui-framework-accent, #5ac8fa);
}
.cm-dot {
  width: 10px;
  height: 10px;
