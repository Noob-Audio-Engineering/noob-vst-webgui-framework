 ...
 *
 * Styling: none. Root class `noob-vst-webgui-framework-resize-grip` plus
 ...
 */
import { useWindowSize } from '../useNoobVstWebguiFramework.js';
...
<template>
  <div v-if="enabled" class="noob-vst-webgui-framework-resize-grip" :class="{ 'is-dragging': dragging }" role="separator" aria-label="Resize window" v-on="gripHandlers">
    <slot />
  </div>
</template>
